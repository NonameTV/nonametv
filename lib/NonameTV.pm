...
sub MonthNumber {
  ...
  my( @months_1, @months_2, @months_3, @months_4, @months_5, @months_6 );
  ...
  if( $lang =~ /^en$/ ){
    ...
    @months_5 = qw/siječnja veljace mart april svibnja lipnja srpnja kolovoza rujna listopada studenog prosinca/;
