#===============================================================================
#       MODULE:  TMDB::API
#       AUTHOR:  Paul Jobson (Cache implent by Joakim Nylén, http://tvtab.la)
...
# This allows declaration   use TMDB::API ':all';
...
sub new {
    ...
    $package::cache = $conf->{ContentCachePath} . 'Tmdb/tmdb.db';
    
    $self->setCacheDB($package::cache);
