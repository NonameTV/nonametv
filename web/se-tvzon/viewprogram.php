...
// main
//
if( isset( $_REQUEST['channel'] ) && is_numeric($_REQUEST['channel']) ) $channel_id = (int) $_REQUEST['channel'];
else {
	print "<h2>" . $lngstrpd['nochanspecified'] . "</h2>";
	doexit();
}
if( isset( $_REQUEST['time'] ) && is_numeric($_REQUEST['time']) ) $showtime = (int) $_REQUEST['time'];
else {
